...
public class SubtractionWindowController2{
	private Main main;
	...
	public void beginSubtraction(){
		answerField.setDisable(false);
		answerField.setText("");
		correctStatement.setText("");
		Random randomGenerator = new Random();
		int beginnerInt = randomGenerator.nextInt(90) + 10;
		randomFirst.setText(Integer.toString(beginnerInt));
		
		Random randomGenerator2 = new Random();
		int beginnerInt2 = randomGenerator2.nextInt(90) + 10;
